...
class cpd_filter_form extends moodleform 
{
	function definition() 
	{
		...
		$mform->addElement('date_selector', 'from', get_string('datefrom', 'report_cpd'), array('startyear'=>(date('Y')-5), 'stopyear'=>(date('Y')+5), 'optional' => false) );
		$mform->addElement('date_selector', 'to', get_string('dateto', 'report_cpd'), array('startyear'=>(date('Y')-5), 'stopyear'=>(date('Y')+5), 'optional' => false) );
